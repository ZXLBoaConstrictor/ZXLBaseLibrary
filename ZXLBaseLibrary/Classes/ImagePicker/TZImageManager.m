...
- (TZAssetModel *)assetModelWithAsset:(id)asset allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage {
    ...
    if ([asset isKindOfClass:[PHAsset class]]) {
        ...
        if (iOS9Later && phAsset.sourceType != PHAssetSourceTypeUserLibrary) {
            return nil;
        }
...
- (void)getVideoOutputPathWithAsset:(id)asset completion:(void (^)(NSString *outputPath))completion {
    if ([asset isKindOfClass:[PHAsset class]]) {
        ...
        [[PHImageManager defaultManager] requestAVAssetForVideo:asset options:options resultHandler:^(AVAsset* avasset, AVAudioMix* audioMix, NSDictionary* info){
            ...
            [self startExportVideoWithVideoAsset:videoAsset Asset:asset completion:completion];
        }];
    } else if ([asset isKindOfClass:[ALAsset class]]) {
...
- (void)startExportVideoWithVideoAsset:(AVURLAsset *)videoAsset Asset:(id)asset completion:(void (^)(NSString *outputPath))completion {
