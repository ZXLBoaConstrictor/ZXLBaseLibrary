...
- (void)configCollectionView {
    ...
    _collectionView = [[TZCollectionView alloc] initWithFrame:CGRectMake(0, top, self.view.tz_width, collectionViewHeight - iOSSafeAreaBottomHeight) collectionViewLayout:layout];
...
- (void)configBottomToolBar {
    ...
    UIView *bottomToolBar = [[UIView alloc] initWithFrame:CGRectMake(0, yOffset - iOSSafeAreaBottomHeight, self.view.tz_width, 50 + iOSSafeAreaBottomHeight)];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.frame = CGRectMake(CGRectGetMaxX(_previewButton.frame), self.view.tz_height - 50 - iOSSafeAreaBottomHeight, fullImageWidth + 56, 50);
...
- (void)doneButtonClick {
    ...
    //warning TODO 修改了源码 点击完成按钮后,禁用按钮点击,防止快速多次点击造成内存暴增闪退
    _doneButton.enabled = !_doneButton.enabled;
    TZImagePickerController *tzImagePickerVc = (TZImagePickerController *)self.navigationController;
